...
<head>
<meta charset="utf-8">
<title>Batch | Cloud Compiler</title>
...
?>
    <div class="edit">
      <form action="batch_output.php" method="post" target="output" id="myForm">
...
?>
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form method="POST" action="saveFile.php" target="_blank">
                      <input type="hidden" value="bat" name="fileType" />
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-2 col-sm-2">
                          <input type="text" class="form-control free" name="fileExt" value="bat" readonly/>
                        </div>
      ...
      <br/>
      <iframe name="output" height="300" width="100%" src="batch_output.php" class="output" id="output">
      </iframe>
    </div>
  </div>
</div>
