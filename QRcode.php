...
<div class="col-lg-12 col-md-12 col-sm-12 text-center">
	 <form action="include/index.php" method="get" target="_blank">
              <textarea name="editorQR" id="Input_CodeQR" class="form-control" rows="15" style="margin:15px 0px 0px 0px;" autofocus></textarea>
              <button type="submit" class="btn btn-default" style="width:150px;margin:15px 0px 0px 0px;" data-toggle="tooltip" data-placement="top" title="Get QR Code"> <span class="glyphicon glyphicon-download"> </span> QR </button>
      </form>
</div>
</div>
</div>
