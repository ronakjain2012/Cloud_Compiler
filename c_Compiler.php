...
?>
    <div class="edit">
      <form action="c_output.php" method="post" target="output" id="myForm">
...
?>
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form method="POST" action="saveFile.php" target="_blank">
                      <input type="hidden" value="c" name="fileType" />
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-2 col-sm-2">
                          <input type="text" class="form-control free" name="fileExt" value="c" readonly/>
                        </div>
      ...
      <br/>
      <iframe name="output" height="300" width="100%" src="c_output.php" class="output" id="output">
      <iframe>
    </div>
  </div>
</div>
