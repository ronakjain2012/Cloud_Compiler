...
?>
    <div class="edit">
      <form action="java_output.php" method="post" target="output" id="myForm">
      	Enter Class Name To Compile <input type="text" size="20" name="className" required/> 
...
?>
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form method="POST" action="saveFile.php" target="_blank">
                      <input type="hidden" value="java" name="fileType" />
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-2 col-sm-2">
                          <input type="text" class="form-control free" name="fileExt" value="java" readonly/>
                        </div>
      ...
      <br/>
      <iframe name="output" height="300" width="100%" src="java_output.php" class="output" id="output">
      <iframe>
    </div>
  </div>
</div>
